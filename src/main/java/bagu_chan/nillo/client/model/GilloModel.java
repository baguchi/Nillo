...
public class GilloModel<T extends Gillo> extends HierarchicalModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = body.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-12.0F, -9.0F, -12.0F, 24.0F, 14.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 4.0F, 0.0F));
		...
		PartDefinition plant = body.addOrReplaceChild("plant", CubeListBuilder.create().texOffs(0, 34).addBox(-3.5F, -7.0F, 0.0F, 6.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(10.5F, -5.0F, -11.0F));

		PartDefinition plant2 = plant.addOrReplaceChild("plant2", CubeListBuilder.create().texOffs(0, 34).addBox(-3.5F, -7.0F, 0.0F, 6.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 1.5708F, 0.0F));
