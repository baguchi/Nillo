...
public class FireNilloRenderer extends MobRenderer<FireNillo, NilloRenderState, NilloModel<NilloRenderState>> {
    ...
    @Override
    public void extractRenderState(FireNillo nillo, NilloRenderState nilloState, float p_361157_) {
