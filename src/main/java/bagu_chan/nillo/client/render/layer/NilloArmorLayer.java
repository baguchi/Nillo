...
public class NilloArmorLayer<T extends Nillo, M extends NilloModel<T>> extends RenderLayer<T, M> {
    ...
    public NilloArmorLayer(RenderLayerParent<T, M> p_316639_, EntityModelSet p_316756_) {
        super(p_316639_);
        this.model = new NilloModel<>(p_316756_.bakeLayer(ModModelLayers.NILLO_ARMOR));
    }
