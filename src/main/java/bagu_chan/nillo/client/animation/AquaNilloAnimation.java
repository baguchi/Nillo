package bagu_chan.nillo.client.animation;// Save this class in your mod and generate all required imports
 ...
 * @author Author
 */
public class AquaNilloAnimation {
    public static final AnimationDefinition swim = AnimationDefinition.Builder.withLength(0.6667F).looping()
